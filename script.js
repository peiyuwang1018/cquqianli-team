    ...
    <div class="recruit-letter-shell">
      ...
      <article class="recruit-letter-content">
        ...
        <section id="recruit-letter-section-07">
          ...
          <blockquote class="recruit-letter-callout recruit-letter-warning"><strong>RoboMaster 是一个投入非常高的比赛。</strong></blockquote>
          ...
          <p>与此同时，如果你的目标主要是综测、保研加分或者尽可能高效地获得竞赛奖项，那么我们需要非常明确地告诉你：<strong>RoboMaster 在这些方面的性价比很低！</strong>部分学院甚至并不认可这项赛事的综测或相关加分。</p>
          <p>同时比赛的正式名额也非常有限，即使投入了一个完整赛季，也不意味着一定能够获得正式参赛名额或者纸质证书。而其中最受关注的 RoboMaster 超级对抗赛，正式参赛队伍本身就有严格的人员名额限制。</p>
